...
<p>
	<?php
		...
		printf( __( 'Your booking at %s has been marked as %s.', 'bookings-and-appointments-for-woocommerce'), $email->blog_name, __($email->booking_status,'bookings-and-appointments-for-woocommerce') );
	?>
</p>
