			...
			<div class="uo-groups">
				<div class="group-management-form">
					...
					<div class="uo-row">
						...
						<div>
							<label class="uo-checkbox">
								<input type="checkbox" name="group_email_status[]" checked="checked"
									   value="not-enrolled" class="uo-checkbox-input bb-custom-check">
								<span class="uo-checkbox-checkmark"></span>
								<span class="uo-row-checkbox__label"><?php _e( 'Not enrolled', 'uncanny-learndash-groups' ); ?></span>
							</label>
						</div>
						<div>
							<label class="uo-checkbox">
								<input type="checkbox" name="group_email_status[]" checked="checked" value="not-started"
									   class="uo-checkbox-input bb-custom-check">
								<span class="uo-checkbox-checkmark"></span>
