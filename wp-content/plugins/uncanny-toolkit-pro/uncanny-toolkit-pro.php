...
if ( class_exists( '\uncanny_learndash_toolkit\Boot' ) ) {
	 ...
	 *
	 */
	define( 'UNCANNY_TOOLKIT_PRO_VERSION', '3.8.1' );
	/**
	 *
	 */
	...
	function uncanny_learndash_toolkit_pro_plugin_settings_link( $links ) {
		//uncanny-pro-toolkit
		$settings_link = '<a href="' . admin_url( 'admin.php?page=uncanny-toolkit-license' ) . '">' . esc_attr__( 'Licensing', 'uncanny-pro-toolkit' ) . '</a>';
